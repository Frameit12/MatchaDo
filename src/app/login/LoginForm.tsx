...
export default function LoginForm({ next, signupHref }: { next: string; signupHref: string }) {
  ...
  return (
    <>
      ...
      <p className="mt-6 text-center text-sm text-zinc-600 dark:text-zinc-400">
        ...
        <Link href={signupHref} className="font-medium text-green-700 dark:text-green-500">
          Sign up
        </Link>
      </p>
    </>
